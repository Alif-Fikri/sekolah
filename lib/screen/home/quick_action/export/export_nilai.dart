...
class ExportNilaiPage extends StatefulWidget {
  ...
  @override
  State<ExportNilaiPage> createState() => _ExportNilaiPageState();
}

class _ExportNilaiPageState extends State<ExportNilaiPage> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8.h),
                    Text(
                      'Pilih kriteria untuk menampilkan data rekap nilai',
  ...
  Widget _tableHeader(String text) {
    return Padding(
      ...
      child: Text(
        text,
        style: LexendTextStyle.semiBold(11.sp, color: AppColors.white),
  ...
  Widget _tableCell(String text) {
    return Padding(
      ...
      child: Text(
        text,
        style: LexendTextStyle.regular(11.sp, color: AppColors.black),
        textAlign: TextAlign.center,
      ),
    );
  }
  ...
  Widget _buildTable() {
    final data = [
      ['1', 'Siti Aminah', '85', '90', '87.5', 'Lulus'],
      ['2', 'Budi Santoso', '70', '65', '67.5', 'Remedial'],
      ['3', 'Andi Prasetyo', '88', '92', '90', 'Lulus'],
      ['4', 'Dewi Kartika', '72', '68', '70', 'Lulus'],
      ['5', 'Rini Susanti', '90', '88', '89', 'Lulus'],
      ['6', 'Ahmad Hidayat', '65', '70', '67.5', 'Remedial'],
      ['7', 'Dewi Kartika', '72', '68', '70', 'Lulus'],
      ['8', 'Dewi Kartika', '72', '68', '70', 'Lulus'],
      ['9', 'Dewi Kartika', '72', '68', '70', 'Lulus'],
    ];
    return Table(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 4.h),
                            Text(
                              'Export data nilai siswa ke format CSV',
                              textAlign: TextAlign.center,
                              style: LexendTextStyle.light(
                                11.sp,
                                color: Colors.white,
